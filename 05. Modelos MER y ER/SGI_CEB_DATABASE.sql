...
CREATE TABLE IF NOT EXISTS `SGI_CEB`.`estudiante` (
  ...
  PRIMARY KEY (`id_estudiante`, `tipo_documento_id_tipo_documento`),
  ...
  INDEX `fk_estudiante_curso_academico1_idx` (`curso_academico_id_curso_academico` ASC),
  ...
  CONSTRAINT `fk_estudiante_nivel_academico1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_estudiante_curso_academico1`
...
CREATE TABLE IF NOT EXISTS `SGI_CEB`.`historial_ingreso_personal` (
  ...
  INDEX `fk_historial_ingreso_personal_usuario1_idx` (`usuario_id_usuario` ASC),
  CONSTRAINT `fk_historial_ingreso_personal_usuario1`
...
CREATE TABLE IF NOT EXISTS `SGI_CEB`.`historial_ingreso_estudiante` (
  ...
  INDEX `fk_historial_ingreso_estudiante_estudiante1_idx` (`estudiante_id_estudiante` ASC),
  CONSTRAINT `fk_historial_ingreso_estudiante_estudiante1`
