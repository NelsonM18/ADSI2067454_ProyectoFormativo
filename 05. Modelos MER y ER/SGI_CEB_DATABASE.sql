...
CREATE TABLE IF NOT EXISTS `SGI_CEB`.`usuario_has_historial_ingreso_personal` (
  ...
  `usuario_tipo_documento_id_tipo_documento` INT NOT NULL,
  `historial_ingreso_personal_id_historialP` INT NOT NULL,
  PRIMARY KEY (`usuario_id_usuario`, `usuario_tipo_documento_id_tipo_documento`, `historial_ingreso_personal_id_historialP`),
  INDEX `fk_usuario_has_historial_ingreso_personal_historial_ingreso_idx` (`historial_ingreso_personal_id_historialP` ASC),
  INDEX `fk_usuario_has_historial_ingreso_personal_usuario1_idx` (`usuario_id_usuario` ASC, `usuario_tipo_documento_id_tipo_documento` ASC),
  CONSTRAINT `fk_usuario_has_historial_ingreso_personal_usuario1`
    FOREIGN KEY (`usuario_id_usuario` , `usuario_tipo_documento_id_tipo_documento`)
    REFERENCES `SGI_CEB`.`usuario` (`id_usuario` , `tipo_documento_id_tipo_documento`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
